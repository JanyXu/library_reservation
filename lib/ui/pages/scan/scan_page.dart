...
//
//   Widget buildImage() {
//     bool falg = widget.landscapeFlag;
//     //- math.pi / 4 向左旋转45度
//     return Transform.rotate(
//         angle: falg ? (math.pi/2):0,
//         child: Image(image: AssetImage('assets/images/main_scan_ground.png'),),);
//   }
//
//   Widget getOrWidget() {
//     return OrientationBuilder(
...
//           orientation == Orientation.portrait ? true : false;
//       print('dssssssssssssssssssss========$width');
//       return Image(image: AssetImage('assets/images/main_scan_ground.png'),);;
//       // return buildScanStack(vm, context);
//     });
//   }
//
